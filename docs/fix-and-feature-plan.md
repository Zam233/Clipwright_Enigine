...
### ����ɣ�2026-08 ִ���ִ� 1��
- ? P2 ǰ�ã�K:\Clipwright Server ���֣�commit 0d973a5��auth+market �Ǽ� 18 �ļ���/health ���ã�ҵ��˵� 501 �� P3/P4��
- ? P2 �ϲ���ǰ�� git subtree ���� web/��221806e��������ʷ������ scripts/start.ps1��bat��check_env��stop��docker-compose��Dockerfile.backend��web/Dockerfile.frontend+nginx��CI��8412751���� һ��������scripts\start.ps1
- ? P0 ȫ�� 14 ��ʵʩ��
  - b249f7b��P0-1 asset ��������import �ܾ����ļ�/�������⸴��/�����У�飩��P0-2 ��Ⱦ��ΰ�����+��� safe_join��P0-3 transition ö��+ע����ˡ�P0-4 tool ·������У�顢P0-7 import-url SSRF+��ʽ������P0-8 RAG �����ء�P0-9 SSE һ���� token��/api/auth/sse-token + ��־Ĩ������P0-12 doc.id У�顢P0-13 ����������P0-14 body ����+/metrics /test ��Ȩ
  - df5a776��P0-5 Persona ǰ����ֶ�ӳ�䣨��˼���У����+UI �ֶΣ�ǰ�� personaFromBackend����P0-6 _io �����õ� to_thread �޸�
  - ǰ�����Σ�persona shape ӳ����� personaApi.get��SSE �ҽ��첽����AgentPanel/ExportPage + sse.ts�������ظ� axios blob ��ƾ�ݡ�pagehide/������ fetch �� Authorization��cw:unauthorized ȫ�ּ������˿�ͳһ 8080��client/settingsStore/URL builders/.env.example/AGENTS.md����integration.spec �Ƴ�Ĭ�� E2E + �½ű� test:e2e:integration
- �ع���֤����� pytest 1005/1005 ? �� ǰ�� 261/261 ? �� typecheck ? �� build ? �� hermetic E2E 45/45 ?

### ����
P1 �ĵ����� �� P3 �˺Ź�����Server 3A + ����Ŀ 3B���� P4 �г� �� P5 �� P6/P7 �� P8 �� P9 �� P10

### ִ���ִ� 2��P1 + P3-3A��
- ? P1 �ĵ����ˣ�19 ���ŵ������ѡһ��أ�workflow.md/structure.md/services_overview.md ��ע A1/A2/A3/A4/A6/A9/A10��requirements_service docstring A8��README ��ݼ����� D9��
- ? P1 �ٳɹ��������Ի�ʽ�༭������ɾ����services/video_editor.py��-404 �У���frame_validator/black_frame_detect/audio_silence_detect/whisper_transcribe/subtitle_overflow �л�Ϊ��ʵʵ��ע�᣻video_filter/text_design �� stub ժ����A7 fatal ����������
- ? P1 parity ���£�requirements 7��8���� /edit����asset 8��9���� /by-path��
- ? P3-3A Server �˺ź���ʵ�֣�K:\Clipwright Server commit 325bb76����register/login/refresh �ֻ�/logout/me/change-password/verify + /api/admin/users��bcrypt��72 �ֽ����ޣ�+ JWT + ��¼������5 ��/5 ���ӣ�+ ����¼���7 �� pytest ȫ����Mongo �������Զ�������
- �ع飺��� 1005/1005 ?

### ִ���ִ� 3��P3-3B ����Ŀ���룩
- ? ��ģʽ��Ȩ��config ���� account_verify_mode(off/token/jwt)/account_url/account_jwt_secret���м�� jwt ģʽ������ǩ��������Կ��+ ��ά���Ƽ��� + request.state ����ע�룻SSE һ���� token �˵����� jwt ģʽ
- ? owner ���ݸ��룺clipwright/authz.py��current_user_id/enforce_owner/filter_by_owner������Ŀȫ CRUD + ����ͼ/����/������/��ǩ����ȨУ�飬list �� owner ���ˣ�jwt ģʽ���������������أ���ȫ���ȣ���Persona create ��¼ owner��update/delete У�飨��ȡ���ֹ�����
- ? ǰ�˻Ự��authStore��access �ڴ� + httpOnly cookie ˢ�£���session ������client ��������/srv ������LoginPage + /login ·�ɡ�App ���ػָ��Ự + 401 �Զ� refresh��ʧ������¼������/pagehide �� fetch ���Ƽ���
- ? Server �ˣ�login/register/refresh д httpOnly cookie��cw_refresh��SameSite=Lax����refresh ֧�� cookie��logout �� cookie
- ? �������ԣ�backend tests/clipwright/test_authz.py��7 ����401/����/α����Կ/owner ����/persona ԽȨ/admin �ƹ�����Server ���� 7 ������
- �ع飺��� 1012/1012 ? �� Server 7/7 ? �� ǰ�� 261/261 + typecheck ?

### ִ���ִ� 4��P3-3B ��β + P4 �г���ˣ�
- ? ���� owner��run-async ��¼������/runs �� owner ���ˣ�jwt ģʽ������¼���أ���status/retry/cancel У������Ȩ
- ? ��Ⱦ owner��queue ��¼ owner_id��״̬��ѯУ�顢�б�����
- ? P4-4A Server �г����ģ�K:\Clipwright Server�������/Persona ������multipart+tar У��+sha256������������ approved�������飨�����ֻ��ܣ������أ�����+1�������֣�ÿ�û�ÿ��һ������admin ��� approve/reject���� zip-slip ��ȱ�嵥�ܾ���11 ������ȫ��
- ? P4-4B ����Ŀ�г���ˣ�market_client������/����/���أ�+ install_service����ȫ�����schema У���ԭ���ƶ���ע���ʧ�ܻع���+ /api/market ����밲װ�˵㣻6 �����߰�װ����
- ? ������persona/loader.py �ظ� import ������B32��
- �ع飺��� 1018/1018 ? �� Server 11/11 ?

### ִ���ִ� 5��P4-4C �г�ǰ�� + P5 ������
- ? P4-4C �г�ҳ��web/src/pages/MarketPage.tsx�����/Persona ˫ Tab����������Ƭ�б�������/��������һ����װ�������� multipart �ϴ���+ market.ts �ͻ��ˣ����������Ŀ /api/market������/����ֱ�� /srv��+ /market ·�� + HomePage TopBar���г������ + �г� flag Ĭ�Ͽ���
- ? P5-B2 �������ƣ�services/rate_limit.py���ڴ滬�����ڣ�+ �м������ user/ip+method+path ���������ȸ��£�Ĭ�Ϲر� CLIPWRIGHT_RATE_LIMIT_ENABLED��
- ? P5-B8 �ݵȼ������� run-async ����Ⱦ queue ֧�� Idempotency-Key ȥ�أ��ظ����󷵻���������
- ? P5-B5 �����־��clipwright/audit.py��Mongo audit ���� + ��־���ף������ project_create/delete��persona_create/delete��pipeline_run��render_queue��market install
- ? �������ԣ�rate_limit 3 ������Ԫ + �м�� 429��
- �ع飺��� 1021/1021 ? �� ǰ�� 261/261 + typecheck ?

### ִ���ִ� 6��P5��C2 �ɱ�׷�� + B3 Ԥ���۶ϣ�
- ? C2��llm_tracker.record_llm_call �־û��� Mongo llm_calls ���ϣ��¼�ѭ�� to_thread��ʧ�ܸ澯������/metrics �� LLM ͳ����ɱ�Ԥ��Ӵ�����ʵ����
- ? B3��services/budget.py ȫ���� token Ԥ�㣨CLIPWRIGHT_LLM_MONTHLY_TOKEN_BUDGET��0=���ޣ������� run-async ����۶ϣ���Ԥ�� 429 ������/�ܶ��60s ����ۺ�
- ? �������ԣ�test_budget 3 ��������/�޶���/���ޣ�monkeypatch �ۺ��� Mongo ����������ȫ��̬��Ⱦ��
- �ع飺��� 1024/1024 ?

### ִ���ִ� 7��P5��B9/B6/����������
- ? B9 �ز�Ӳ���ˣ�material_agent ��ѡӲ�޳���ʱ��<3s����֪�ֱ��ʷ��򲻷��������˺�Ϊ�ջ���ԭ��ѡ����ת
- ? B6 ��Ȩ�ֶΣ�MaterialAsset.license �ֶ� + �زĽ���͸����ǰ�˿�չʾ���ز�Դ���ṩ��
- ? ����������GET /api/stats/usage������/��Ⱦ/LLM tokens �������ܼƣ�jwt �� owner ���ˣ�+ ����ҳ������ͳ�ơ���Ƭ
- �ع飺��� 1024/1024 ? �� ǰ�� 261/261 + typecheck ?

### ִ���ִ� 8��P5 ��β��B7/B4/Agent ������
- ? B7 �෽����structure_agent voiceover ģʽ˫������ + ��������ʽ�������� 3-20 �����ڶ����ţ�Խ��ͷ���ƽ��ȡ�ȣ�
- ? B4 ���г־û�����Ⱦ������ Mongo render_tasks���� timeline/���ȼ� X-Priority 1-5������̬ͬ����60s �������������� GET /queue �ϲ��ָ��recovered ��ǣ���״̬��ѯ Mongo ����
- ? Agent ͳһ������BaseAgent.run_with_timeout / llm_or_fallback����ʱ+�쳣���Ž�����
- ? �������ԣ�test_p5_unit 4 �������� 3 + ���лָ� 1���� Mongo ������
- �ع飺��� 1028/1028 ? ���� P5 �׶�ȫ�����

### ִ���ִ� 9��P6 �༭��רҵ���� �� ��һ����
- ? M7 �������/���ԣ�Track.hidden �ֶ� + timelineStore.toggleTrackHidden + ����/Ԥ���������ع�� + ������������۾���ť
- ? M10 �����л���ݼ���Alt+S
- ? M12 In/Out ���䲥�� UI ��ť��ʱ���Ṥ���� ���/����/�����setMarkerIn/Out + loopRegion �������У�
- ? M9 �ز�ɾ�� UI��assetApi.remove����� DELETE ���У�+ AssetCard ɾ����ť + ȷ�� + ���߱����Ƴ�
- ? A1 ��Ŀ����ProjectsPage ����༭/���� �л�
- �ع飺ǰ�� 261/261 + typecheck + build ?��P6 ʣ�� 21 ��ƻ�������

        ...
        **kwargs: Any,
        ...
        try:
            ...
            filter_map = {
                ...
                "slide_left": f"xfade=transition=slideright:duration={t}:offset=1",
                "slide_right": f"xfade=transition=slideleft:duration={t}:offset=1",
                "slide_up": f"xfade=transition=slideup:duration={t}:offset=1",
                "slide_down": f"xfade=transition=slidedown:duration={t}:offset=1",
                "push_left": f"xfade=transition=pushright:duration={t}:offset=1",
                "push_right": f"xfade=transition=pushleft:duration={t}:offset=1",
